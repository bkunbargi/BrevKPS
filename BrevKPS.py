...
class KPSScaleNode:
    ...
    def scale_keypoints(self, normalized_keypoints, scale_factor, position_x=None, position_y=None):
        ...
        # If scale is 1 and no position change, return original keypoints
        ...
        for kp in normalized_keypoints['keypoints']:
            ...
            scaled_kp = {
                'x': new_position['x'] + dx if new_position else kp['x'] + (dx - (kp['x'] - nose_kp['x'])),
                'y': new_position['y'] + dy if new_position else kp['y'] + (dy - (kp['y'] - nose_kp['y'])),
                'feature': kp['feature']
            }
    ...
    def process_kps(self, image, scale_factor, position_x=None, position_y=None):
        try:
            ...
            # Scale keypoints with optional position
